...
#Automatically started from beginning
...
def main_page():
    ...
    #START OPTIONS : FRESH OR WITH PREDEFINED HABITS
    freshyesno = True
    ...
    while choice.lower() != 'q':
        ...
        if choice == '1':  # Create new habits
            print("\nCreate New Habit\n")
            myhabits.useranalyze1() # Display all habits before add new habits
            myhabits.usercreation()
            myhabits.useranalyze1() # Display all habits after new habits created
            time.sleep(1)  # sleep 1 secs
            print("\nGO TO MAIN PAGE\n")

        elif choice == '2':  # complete tasks(checkoff)
            print("\nComplete Tasks\n")
            myhabits.useranalyze1() # Display all habits before check
            myhabits.usercheckoff() # """Complete task, checkoff"""
            myhabits.useranalyze1() # Display all habits after checkoff
            ...
            while manage_choice.lower() != 'x':
                ...
                if manage_choice == '1':  # DELETE HABIT
                    print("\nDELETE HABIT\n")
                    myhabits.useranalyze1()  # Display all habits before deletion
                    myhabits.userdeletion()  # Delete Habit
                    myhabits.useranalyze1()  # Display all habits after deletion
                    time.sleep(3)  # sleep 2 sec
                    print("\nGO TO MANAGE PAGE\n")

                elif manage_choice == '2':  # EDIT HABIT'S TITLE
                    print("\nEDIT HABIT'S TITLE\n")
                    myhabits.useranalyze1()  # Display all habits before edit
                    myhabits.useredittitle()  # Edit Habit
                    myhabits.useranalyze1()  # Display all habits after edited
                    ...
                    print("\nNO OPTION FOR IT. PLEASE INPUT CORRECT OPTION.\n")
            ...
            while analyze_choice.lower() != 'x':
                ...
                if analyze_choice == '1':  # DISPLAY ALL HABITS
                    print("\nDISPLAY ALL HABITS\n")
                    myhabits.useranalyze1() #Display all habits
                    time.sleep(1)  # sleep 1 sec
                    print("\nGO TO ANALYZE PAGE\n")
